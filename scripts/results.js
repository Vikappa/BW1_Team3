  ...
  if (pass === "superato") {
    ...
    const iniziaLacrime = (timestamp) => {
      ...
      for (let i = 0; i < lacrime.length; i++) {
        ...
        if (lacrime[i].y - lacrime[i].dimension > height) {
          lacrime[i].y = -lacrime[i].dimension;
        }
      }
